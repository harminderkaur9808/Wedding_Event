...
<head>
    ...
    <title>User Registration - Vikram & Nisha's Wedding</title>
    <style>
    ...
    <div class="email-wrapper">
        ...
        <div class="email-body">
            <div class="content-inner">
                ...
                <p class="intro">A new user has registered on Vikram & Nisha's Wedding Website.</p>

                <div class="user-details">
                    <div class="detail-row"><span class="detail-label">Name</span>: <span class="detail-value">{{ $user->first_name }} {{ $user->last_name }}</span></div>
                    ...
                    <div class="detail-row"><span class="detail-label">Registration Date</span>: <span class="detail-value">{{ $user->created_at->format('n/j/y') }}</span></div>
                </div>

                <p class="status-text">The account is currently pending approval.</p>

                <div class="email-cta-row">
                    <span class="cta-label">Review &amp; Approve User</span>
                    <a href="{{ $adminDashboardUrl }}" class="email-cta-btn">Click here</a>
                </div>

                <p class="note-text">Please log in to the admin panel to approve or manage this user.</p>
            </div>
        </div>
