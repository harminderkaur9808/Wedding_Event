                ...
                <div class="wedding-mele-invitation-left wm-reveal wm-reveal--left" style="--reveal-delay: 220ms;">
                    ...
                    <div class="wedding-mele-invitation-details">
                        <div class="wedding-mele-detail-item">
                            ...
                            >
                            <span class="wedding-mele-detail-text">Dress Code: {{ $fourth?->getExtra('dress_code') ?? 'Traditional Outfits' }}</span>
                        </div>
                        ...
                        <div class="wedding-mele-detail-item">
                            <img
                                ...
                                class="wedding-mele-detail-icon"
                            >
                            <span class="wedding-mele-detail-text">Date: {{ $fourth?->getExtra('date') ?? '2/21/2026' }}</span>
                        </div>
                        ...
                        <div class="wedding-mele-detail-item">
                            <img
                                ...
                                class="wedding-mele-detail-icon"
                            >
                            <span class="wedding-mele-detail-text">Time: {{ $fourth?->getExtra('time') ?? '9 am - 12 pm' }}</span>
                        </div>
                        ...
                        <div class="wedding-mele-detail-item">
                            <img
                                ...
                                class="wedding-mele-detail-icon"
                            >
                            <span class="wedding-mele-detail-text">Venue: {{ $fourth?->getExtra('venue') ?? 'Phoenix AZ' }}</span>
                        </div>
                    </div>
                </div>
