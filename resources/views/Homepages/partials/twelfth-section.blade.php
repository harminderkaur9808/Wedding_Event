                ...
                <div class="wedding-mele-twelfth-left wm-reveal wm-reveal--left" style="--reveal-delay: 220ms;">
                    <div class="wedding-mele-twelfth-details">
                        <div class="wedding-mele-twelfth-detail-item">
                            ...
                            <span class="wedding-mele-twelfth-detail-text">Date: <span>{!! nl2br(e(preg_replace('/<br\s*\/?>/i', "\n", $twelfth?->getExtra('date') ?? '1/2/2027'))) !!}</span></span>
                        </div>
                        <div class="wedding-mele-twelfth-detail-item">
                            <img src="{{ asset('Images/Home/fifthsec/time_svg_fifth.svg') }}" alt="Time" class="wedding-mele-twelfth-detail-icon">
                            <span class="wedding-mele-twelfth-detail-text">Time: <span>{!! nl2br(e(preg_replace('/<br\s*\/?>/i', "\n", $twelfth?->getExtra('time') ?? '6 pm onwards'))) !!}</span></span>
                        </div>
                        <div class="wedding-mele-twelfth-detail-item">
                            <img src="{{ asset('Images/Home/fifthsec/venue_svg_fifth.svg') }}" alt="Venue" class="wedding-mele-twelfth-detail-icon">
                            <span class="wedding-mele-twelfth-detail-text">Venue: <span>{!! nl2br(e(preg_replace('/<br\s*\/?>/i', "\n", $twelfth?->getExtra('venue') ?? 'Park Hyatt Aviara Resort-760-448-1234'))) !!}</span></span>
                        </div>
                        <div class="wedding-mele-twelfth-detail-item">
