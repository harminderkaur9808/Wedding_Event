<section class="wedding-mele-our-story-section">
    <!-- Left Decorative Frame -->
    <div class="wedding-mele-left-frame">
        <img src="{{ asset('Images/Home/SecSection/Left_Frame_best1_h1.png') }}" alt="Left Decorative Frame" class="wedding-mele-frame-image">
    </div>
            ...
            <div class="wedding-mele-story-center-content">
                ...
                <div class="wedding-mele-person-section wedding-mele-vickram-section">
                    <div class="wedding-mele-text-bubble wedding-mele-left-bubble">
                        ...
                        <img src="{{ asset('Images/Home/SecSection/Lefttxt_box.png') }}" alt="Left Text Box" class="wedding-mele-bubble-bg">
                    </div>
                </div>
                ...
                <div class="wedding-mele-person-section wedding-mele-nisha-section">
                    <div class="wedding-mele-text-bubble wedding-mele-right-bubble">
                        ...
                        <img src="{{ asset('Images/Home/SecSection/rightttxt_box.png') }}" alt="Right Text Box" class="wedding-mele-bubble-bg">
                    </div>
                </div>
            </div>

            <!-- Timeline -->
            <div class="wedding-mele-timeline">
                <div class="wedding-mele-timeline-line"></div>
                <div class="wedding-mele-timeline-dot wedding-mele-timeline-dot-left"></div>
                <div class="wedding-mele-timeline-dot wedding-mele-timeline-dot-right"></div>
            </div>
        </div>
    </div>
</section>
