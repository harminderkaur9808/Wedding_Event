...
@section('title', 'Reset Password - Wedding Event')
...
<div class="login-wed-lex1-container" id="mainContent" style="display: none;">
    ...
    <div class="container-fluid login-wed-lex1-wrapper">
        <div class="login-wed-lex1-title-section">
            ...
            <h1 class="login-wed-lex1-title">Reset Password</h1>
        </div>
        ...
        <div class="row g-0 login-wed-lex1-row">
            ...
            <div class="col-lg-6 login-wed-lex1-form-section">
                <div class="login-wed-lex1-form-wrapper">
                    ...
                    <p class="login-wed-lex1-forgot-intro">Enter your new password below. Your email is pre-filled from the reset link.</p>

                    <form class="login-wed-lex1-form" method="POST" action="{{ route('password.update') }}">
                        @csrf
                        ...
                        <div class="login-wed-lex1-form-group">
                            ...
                            <input type="email" id="email" name="email" class="login-wed-lex1-input login-wed-lex1-input-readonly" value="{{ old('email', $email) }}" required readonly>
                        </div>

                        <div class="login-wed-lex1-form-group">
                            <label for="password" class="login-wed-lex1-label">New password <span class="login-wed-lex1-required">*</span></label>
                            <div class="login-wed-lex1-password-wrapper">
                                <input type="password" id="password" name="password" class="login-wed-lex1-input @error('password') is-invalid @enderror" placeholder="New password" required autofocus minlength="6">
                        ...
                        <div class="login-wed-lex1-form-group">
                            <label for="password_confirmation" class="login-wed-lex1-label">Confirm new password <span class="login-wed-lex1-required">*</span></label>
                            <div class="login-wed-lex1-password-wrapper">
                                <input type="password" id="password_confirmation" name="password_confirmation" class="login-wed-lex1-input" placeholder="Confirm new password" required minlength="6">
                        ...
                        <button type="submit" class="login-wed-lex1-submit-btn">Change password</button>

                        <div class="login-wed-lex1-signup-wrapper">
                            <p class="login-wed-lex1-signup-text"><a href="{{ route('login') }}" class="login-wed-lex1-signup-link">Back to Login</a></p>
                        </div>
                    </form>
                </div>
            </div>
...
function togglePassword(inputId) {
    ...
    if (!input) return;
    var wrapper = input.closest('.login-wed-lex1-password-wrapper');
    var eyeOpen = wrapper.querySelector('.login-wed-lex1-eye-open');
    var eyeClosed = wrapper.querySelector('.login-wed-lex1-eye-closed');
