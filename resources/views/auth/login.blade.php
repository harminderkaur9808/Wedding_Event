    ...
    <div class="login-wed-lex1-infinity-loader">
        <svg class="login-wed-lex1-infinity-svg" viewBox="0 0 200 100" xmlns="http://www.w3.org/2000/svg">
            <defs>
                ...
                <linearGradient id="loaderGradient2" x1="0%" y1="0%" x2="100%" y2="0%">
                    <stop offset="0%" style="stop-color:#0055A5;stop-opacity:1" />
                    <stop offset="50%" style="stop-color:#A3A5C7;stop-opacity:1" />
                    <stop offset="100%" style="stop-color:#2F4F75;stop-opacity:1" />
                </linearGradient>
            </defs>
