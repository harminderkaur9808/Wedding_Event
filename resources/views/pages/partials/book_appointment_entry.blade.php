<div class="book-appointments-detail-block">
    ...
    <p class="book-appointments-detail-instruction">{{ $entry->instruction }}</p>
    @endif
    ...
    <div class="book-appointments-detail-row">
        ...
        <span>Website: <a class="book-appointments-detail-link" href="{{ $entry->website }}" target="_blank" rel="noopener noreferrer">Visit Website</a></span>
    </div>
    @endif
    @if(!empty($entry->map_url))
    <div class="book-appointments-detail-row">
        ...
        <span>Map Location: <a class="book-appointments-detail-link" href="{{ $entry->map_url }}" target="_blank" rel="noopener noreferrer">Click Here</a></span>
    </div>
    @endif
